        ...
        <div className="container flex">
            ...
            <div className="flex items-center justify-between flex-grow md:pl-12 py-5">
                <div className="flex items-center space-x-6 capitalize">
                    ...
                    <NavLink to={"/about"} className="text-gray-200 hover:text-white transition">About us</NavLink>
                    <NavLink to={"/contact"} className="text-gray-200 hover:text-white transition">Contact us</NavLink>
                </div>
